...
//=======
        private static string connectionString = "Data Source =172.17.16.14; Initial Catalog = Stundenplan; User ID = sa; Password=Viper001!";
        private static string connectionString_timetable = "Data Source =172.17.16.14; Initial Catalog = Stundenplan-Original; User ID = sa; Password=Viper001!";
